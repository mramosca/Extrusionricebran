...
metadata$Time.ord = factor(metadata$Time, c("0", "24" ))
...
my_column <- "Time"  #this is the metadata column that we will use in the taxa barplot
my_column_ordered <- c("0", "24" )
...
for(ml in my_level){
  ...
  ggplot(physeq_meta_filtered, aes(x = my_column_ordered, y = Abundance.average, fill = get(ml))) + 
    ...
    xlab(my_column) +
    ggtitle(paste0(ml, " (>", abund_filter * 0.23,"%) in at least 1 sample")) 
...
run_deseq2("Time", "0", "24")
#run_deseq2("Time", "0", "0.11")
#run_deseq2("Time", "0", "0.14")
#run_deseq2("Time", "0" )
#run_deseq2("Time", "0", "NOT EXTRUDED")
#run_deseq2("Time", "0", "0.23")
#run_deseq2("Time", "24", "0.11")
#run_deseq2("Time", "24", "0.14") 
#run_deseq2("Time", "24" ) 
#run_deseq2("Time", "24", "NOT EXTRUDED") 
#run_deseq2("Time", "24", "0.23")
#run_deseq2("Time", "0.23", "0.11")
#run_deseq2("Time", "0.23", "0.14")
#run_deseq2("Time", "0.23" )
#run_deseq2("Time", "0.23", "NOT EXTRUDED")
#run_deseq2("Time", "NOT EXTRUDED" )
#run_deseq2("Time", "NOT EXTRUDED", "0.14")
#run_deseq2("Time", "NOT EXTRUDED", "0.11")
#run_deseq2("Time" , "0.14")
#run_deseq2("Time" , "0.11")
run_deseq2 <- function(my_factor, x, y){
  ...
  #Let's look at the OTUs that were significantly different between the two Time groups. The following makes a nice ggplot2 summary of the results.
  ...
  ggsave(paste0("output/taxa/taxamoist/DESeq2-", my_contrast[2], "-", my_contrast[3], ".png"), DESeq_fig, height = 5, width = 10)
}
